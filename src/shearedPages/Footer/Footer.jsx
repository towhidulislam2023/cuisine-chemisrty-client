...
const Footer = () => {
    return (
       ...
       <footer className="footer md:w-[75%] mx-auto p-10 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">Recipes</span>
                    <a className="link link-hover">Main dishes</a>
        ...
        <footer className="footer md:w-[75%] mx-auto px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Cuisine Chemistry <br />Providing reliable food since 2022</p>
                </div>
