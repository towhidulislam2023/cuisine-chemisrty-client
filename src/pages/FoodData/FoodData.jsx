...
const FoodData = () => {
    ...
    return (
        <div className='bg-gray-200 md:w-[75%] mx-auto my-16 p-6 pb-11 rounded-lg'>
            <div className=''>
                ...
                <div className='grid md:grid-cols-6 gap-6 px-3'>
                    {
                        foodData && foodData.map(food => <div key={food.id} className="card w bg-base-100 shadow-xl image-full">
